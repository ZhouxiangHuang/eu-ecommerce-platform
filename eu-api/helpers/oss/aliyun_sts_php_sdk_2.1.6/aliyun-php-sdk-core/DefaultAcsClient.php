...
require_once __DIR__ . '/IAcsClient.php';
require_once __DIR__ . '/Regions/EndpointProvider.php';
require_once __DIR__ . '/Exception/ClientException.php';
require_once __DIR__ . '/Http/HttpHelper.php';
...
{	
	...
	public function doAction($request, $iSigner = null, $credential = null, $autoRetry = true, $maxRetryNumber = 3)
	{
        ...
        Slim::getInstance()->getLog()->debug($request->getProduct());
