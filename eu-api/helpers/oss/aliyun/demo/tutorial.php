<?php
use Module\Kernel\FileSystem\OSS\Aliyun\ALIOSS;
/**
 * 加载sdk包以及错误代码包
 */
...
//   	upload_by_file($oss_sdk_service);
	 ...
	 * 外链url相关
	 */
//	var_dump(get_sign_url($oss_sdk_service));
...
function upload_by_file($obj){
	$bucket = 'vlicense';
	$object = 'vehicleLicense/555475c2e28e1.jpg';
	$file_path = realpath(__DIR__) . "/555475c2e28e1.jpg";
...
function get_object($obj){
    $bucket = 'vlicense';
    $object = 'driveLicense/555578ae01020.jpg';
//	$bucket = 'phpsdk1349849394';
//	$object = 'netbeans-7.1.2-ml-cpp-linux.sh';
	
	$options = array(
		ALIOSS::OSS_FILE_DOWNLOAD => __DIR__ . "1.jpg",
...
function get_sign_url($obj){
	$bucket = 'westie';
	$object = 'driverLicense/555475c2e28e1.jpg';
	$timeout = 3600;
