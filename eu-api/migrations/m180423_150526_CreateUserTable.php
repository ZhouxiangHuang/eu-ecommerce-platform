 ...
 */
class m180423_150526_CreateUserTable extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        ...
        $this->createTable('{{%users}}', [
            'id' => $this->primaryKey(),
            'wx_union_id' => $this->string(18)->notNull()->comment('unionId'),
            'wx_open_id' => $this->string(18)->notNull()->comment('openId'),
            'role' => $this->integer(1)->notNull()->comment('角色'),
            'mobile' => $this->string(18)->notNull()->comment('手机号'),
            'country' => $this->string(10)->comment('国家'),
            'wechat_profile' => $this->string(30)->notNull()->comment('微信头像'),
